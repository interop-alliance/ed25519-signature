...
These conventions are also provided to coding agents via the `@CONTRIBUTING.md`
include in [AGENTS.md](AGENTS.md) -- see that file for repo-specific
architecture, toolchain, and testing guidance.
